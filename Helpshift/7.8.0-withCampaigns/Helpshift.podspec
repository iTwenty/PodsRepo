Pod::Spec.new do |s|
  ...
  s.platform            = :ios, '8.0'
  s.source_files        = 'helpshift-sdk-ios-v7.8.0-withCampaigns/Helpshift.framework/Headers/*.h'
  s.resources           = 'helpshift-sdk-ios-v7.8.0-withCampaigns/Helpshift.framework/HsUIResources.bundle', 'helpshift-sdk-ios-v7.8.0-withCampaigns/Helpshift.framework/HsLocalization.bundle', 'helpshift-sdk-ios-v7.8.0-withCampaigns/Helpshift.framework/HelpshiftConfig*.plist'
